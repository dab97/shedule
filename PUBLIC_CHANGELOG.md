...
### Инфраструктура
- **Миграция на Netlify** 🚀:
  - Переезд с Vercel на Netlify для увеличения лимитов
  - Bandwidth увеличен с 10 GB до 100 GB в месяц
  - Новый адрес: `https://shedule-rgsu.netlify.app`
  - Полная поддержка Next.js 16 и всех функций приложения

### Безопасность
- **Исправлены уязвимости** 🔒:
  - Обновлена библиотека jsPDF для устранения критических уязвимостей
  - Исправлены проблемы PDF Injection и XSS
